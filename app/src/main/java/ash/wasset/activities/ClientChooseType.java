...
public class ClientChooseType extends Activity implements View.OnClickListener, Response.Listener, Response.ErrorListener {
...
//                    permission is denied
    ...
    private void loginClick() {
        finish();
        Intent toLogin = new Intent(ClientChooseType.this, LoginActivity.class);
    ...
    private void callServerToRegister() {
        ...
        users.setPhoneNo(clientMobileEditText.getText().toString());
        ...
        ConnectionVolley connectionVolley = new ConnectionVolley(this, Request.Method.POST, Url.getInstance().clientRegistrationURL, this, this, parms, true);
